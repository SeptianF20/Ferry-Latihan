    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <label for="kelamin">Jenis Kelamin : <label>
            <input type="radio" id="pria" name="kelamin" value="Laki-laki" required> Laki-laki
            <input type="radio" id="wanita" name="kelamin" value="WANITA" required> Perempuan              
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <textarea class="form-control form-control-user" id="biografi" name="biografi" required></textarea>
        </div>
        ...
        if($kelamin) {
            echo "<strong>Status Kelamin:</strong> {$kelamin} <br>";
        }
        if($agama) {
